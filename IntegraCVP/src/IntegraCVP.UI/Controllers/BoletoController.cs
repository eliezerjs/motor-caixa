...
namespace IntegraCVP.UI.Controllers
{
    ...
    {
        private readonly IBoletoM1Service _boletoService;
        private readonly IBoletoM2Service _boletoV2Service;

        private readonly IReturnDataConverterService _dataConverterService;
        public BoletoController(IBoletoM1Service boletoService, IBoletoM2Service boletoV2Service, IReturnDataConverterService dataConverterService)
        {
