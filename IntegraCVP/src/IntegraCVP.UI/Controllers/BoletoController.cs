...
namespace IntegraCVP.UI.Controllers
{
    ...
    public class BoletoController : ControllerBase
    {
        ...
        public BoletoController(IBoletoService boletoService, IBoletoV2Service boletoV2Service, ISeguroGrupoService SeguroGrupoService, ISeguroService SeguroService, IDataConverterService dataConverterService)
        {
        ...
        [HttpPost("gerar-vd02")]
        public async Task<IActionResult> GerarBoletoVD02([FromForm] FileUploadModel model)
        {
            ...
            byte[] pdfData = _boletoService.GerarBoletoPdf(boletosVD02.FirstOrDefault());
